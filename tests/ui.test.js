...
check('stage-5k: CALM_RGBA agrees with the 0 ft stop (single source of truth)', () => {
  eq(ui.CALM_RGBA, [42, 88, 133, 115]);
  eq(ui.CALM_RGBA, [ui.HS_STOPS[0][1], ui.HS_STOPS[0][2], ui.HS_STOPS[0][3], 115]);
